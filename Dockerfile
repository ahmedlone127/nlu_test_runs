...
RUN python3.6 -m pip install ! pip install --index-url https://test.pypi.org/simple/ --extra-index-url https://pypi.org/simple nlu_spark23==1.1.1rc3 \
	&& python3.6 -m pip install pyspark==2.4\
